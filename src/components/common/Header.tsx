...
export const Header: React.FC<HeaderProps> = ({ currentView, onNavigate }) => {
  ...
  return (
    <header
      ...
      className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200/80 px-4 sm:px-6 py-3 transition-all"
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          ...
          >
            ...
            <div>
              <div className="flex items-center gap-1.5">
                ...
                <span className="hidden sm:inline-flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider text-emerald-700 bg-emerald-50 px-1.5 py-0.5 rounded border border-emerald-200/60">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {/* VS Code (Web Beta) button with option to open in current tab or new window */}
          <button
            type="button"
